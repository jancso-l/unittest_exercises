...
"""
Exercise 1:
Using the unittest.mock library import the Mock class. Then create an instance of this class with the name 'first_mock' (the name argument of the Mock class) and assign it to a variable named mock.
...
Mock the random.choice() method from the random built-in module so that when this method is called, it returns 'aws' each time. Use the return_value argument of the Mock class for this purpose. Then call the random.choice() method and print the result to the console.
"""
...
"""
Exercise 3:
The method random.choice() is mocked (from the random built-in module). Display the value of the call_count attribute of the mocked random.choice() method. Then call the random.choice() method once and display the value of the call_count attribute to the console again.
"""
...
"""
Exercise 4: 
The implementation of the Programmer class is given. An instance of this class named programmer is also created. Using the unittest.mock library, mock the random.choice() method so that it returns the name of the technology 'python' each time it is called. Then call the get_random_tech() method on the programmer instance and print the returned value to the console.
"""
...
"""
Exercise 5
The implementation of the Programmer class is given. An instance of this class named programmer is also created. Using the patch() function from the unittest.mock library and the context manager, mock the random.choice() method so that it returns the technology name 'sql' every time it is called within the context manager. Then, within the context manager, call the get_random_tech() method on the programmer instance and print the returned value to the console.
"""
...
"""
Exercise 6
The implementation of the Programmer class is given. An instance of this class named programmer is also created. At the module level implement a function called test_get_random_tech() that will return the result of calling the get_random_tech() method on the programmer instance. Then, using the @patch decorator from the unittest.mock library, decorate the test_get_random_tech() function and mock the random.choice method so that each time the random.choice method is called inside test_get_random_tech(), the technology name 'c++' is returned. Then call the test_get_random_tech() function and print the result to the console.
"""
...
"""
Exercise 7
The implementation of the get_code() function is given in the code_generator.py file. Implement a class named TestGetCode that inherits from unittest.TestCase and implements a test method named test_get_code_mock_should_return_30(). The method is designed to test the get_code() function. Since the function works pseudo-randomly, we cannot predict its exact result every time.

Using the @patch() decorator mock the random.randint method within test_get_code_mock_should_should_return_30() so that in the test method, calling this method returns 30. Then, assert the result of calling get_code() with the expected result 'CX-30'.
"""

import unittest
from unittest.mock import patch
# from src.code_generator import get_code

# class TestGetCode(unittest.TestCase):
#     @patch("random.randint", return_value = 30)
#     def test_get_code_mock_should_return_30(self, mock):
...
from src.message_generator import get_message

# class TestGetMessage(unittest.TestCase):
#     @patch("src.message_generator.get_today_name", return_value = "Friday")
#     def test_get_message_with_friday(self, mocked):
#         actual = get_message()
...
# class TestGetMessage(unittest.TestCase):
#     @patch('src.message_generator.get_today_name')
...
"""
from src.code_generator2 import get_code_with_day

# class TestGetCodeWithDay(unittest.TestCase):

#     @patch("random.randint", return_value = 5)
#     @patch("src.code_generator2.get_today_name", return_value = "FRI")
...
# class TestGetCodeWithDay(unittest.TestCase):
#     @patch('src.code_generator2.get_today_name')
...
# from src.employees import Programmer
...
"""
from src.employees2 import Programmer
...
class TestProgrammer(unittest.TestCase):
    ...
    @patch.object(Programmer, "get_random_tech")
    def test_display_random_tech_mocked(self, mocked_tech):
        mocked_tech.return_value = "python"
        actual = self.programmer.display_random_tech()
        self.assertEqual(actual, 'Technology name: python')
    ...
    def test_display_random_tech_mocked_cpp(self, mocked_tech):
        ...
        actual = self.programmer.display_random_tech()
        self.assertEqual(actual, 'Technology name: c++')
